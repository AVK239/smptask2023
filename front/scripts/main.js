...
document.querySelector(".header__title_btn").addEventListener("click", function() {
  ...
  if (header.offsetWidth > 150) {
    header.style.transition = "width 0.3s";
    header.style.width = "5.3%";
...
document.querySelector(".section__4_menu").addEventListener("click", function() {
  if (document.querySelector(".section__4_delete").style.display == "none") {
    ...
    document.querySelectorAll(".section__4_main_elem").forEach(elem => {
      elem.classList.remove("section__4_main_elem");
      elem.classList.add("section__4_main_elem_delete");
    });
  }
  else {
    document.querySelector(".section__4_delete").style.display = "none";
    ...
    document.querySelectorAll(".section__4_main_elem_delete").forEach(elem => {
      elem.classList.add("section__4_main_elem");
      elem.classList.remove("section__4_main_elem_delete");
    });
  };
});
...
document.querySelectorAll(".section__bucket_main_down_main_elem_input").forEach(elem => {
  elem.addEventListener("click", function() {
    if (elem.checked == true) {
      elem.checked = false;
    }
